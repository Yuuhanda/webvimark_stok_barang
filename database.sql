...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2024 at 05:14 AM
...
('7726f95bf7303f0e3d4b49f352ede068', 1733720071, 0x613a323a7b693a303b613a303a7b7d693a313b4e3b7d),
...
--
ALTER TABLE `item`
  MODIFY `id_item` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=39;
...
--
ALTER TABLE `lending`
  MODIFY `id_lending` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=25;
...
--
ALTER TABLE `repair_log`
  MODIFY `id_repair` int(10) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=157;
...
--
ALTER TABLE `unit_log`
  MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=117;
