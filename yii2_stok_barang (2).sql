...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2024 at 05:24 AM
...
(54217, 12, 2, 7, 'test add new unit 111', 'OJWL-5502BT-GD', 1, 1),
...
--
ALTER TABLE `item_unit`
  MODIFY `id_unit` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54219;

--
-- AUTO_INCREMENT for table `lending`
--
ALTER TABLE `lending`
  MODIFY `id_lending` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
