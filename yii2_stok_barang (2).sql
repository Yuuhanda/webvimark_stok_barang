...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2024 at 07:15 AM
...
('7726f95bf7303f0e3d4b49f352ede068', 1733209415, 0x613a323a7b693a303b613a303a7b7d693a313b4e3b7d),
...
(1, 11, 1, 5, 'new data after purge', 'PA24-0001-0001', 1, 1),
...
(129, 12, 1, 13, 'SPAM PREVENTION TEST', 'PA24-0002-0001', 2, 1),
...
(193, 13, 3, 5, 'rep sample', 'PC24-0001-0001', 2, 1),
...
(257, 14, 1, 13, 'rep sample aaa', 'PA24-0003-0001', 2, 1),
...
(321, 15, 3, 13, 'rep sample b', 'VD24-0001-0001', 2, 1),
...
(385, 16, 1, 13, 'rep sample d', 'VD24-0002-0001', 2, 9),
...
(513, 25, 1, 13, 'new data after purge ', 'PA24-0004-0001', 2, 9),
...
CREATE TABLE `unit_log` (
  ...
  `id_unit` int(10) NOT NULL COMMENT 'foreign key - item_unit',
  `content` varchar(255) NOT NULL COMMENT 'content of the log, text',
...
(4, 'appadmin', '$2y$13$.X94ue5lX8Yt10motmlym.HyhumhiBXBZ7leukSITV7e9sTgLjNrK', 1, 0, '2024-10-28 13:20:22.00', '0000-00-00 00:00:00.00', '::1', 'bogosbinted@mail.com', 'pUwr74uXpIAq5h1XQU-3y3PuplNbm2P8', '', 1, '', 5, 'en'),
...
--
ALTER TABLE `doc_uploaded`
  MODIFY `id_doc` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
  MODIFY `id_employee` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `item`
--
ALTER TABLE `item`
  MODIFY `id_item` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `item_category`
--
ALTER TABLE `item_category`
  MODIFY `id_category` int(10) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `item_unit`
--
ALTER TABLE `item_unit`
  MODIFY `id_unit` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=1042;

--
-- AUTO_INCREMENT for table `lending`
--
ALTER TABLE `lending`
  MODIFY `id_lending` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=22;
...
--
ALTER TABLE `repair_log`
  MODIFY `id_repair` int(10) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=135;
...
--
ALTER TABLE `unit_log`
  MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=71;
...
--
ALTER TABLE `warehouse`
  MODIFY `id_wh` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=16;
