	...
	*/
	public function rules()
	{
		return [
			...
			[['status', 'email_confirmed', 'id_wh'], 'integer'],
	...
	public function attributeLabels()
	{
		return [
			...
			'created_at'         => UserManagementModule::t('back', TranslationHelper::translate('Created')),
			'updated_at'         => UserManagementModule::t('back', TranslationHelper::translate('Updated')),
			'password'           => UserManagementModule::t('back', TranslationHelper::translate('Password')),
			'repeat_password'    => UserManagementModule::t('back', TranslationHelper::translate('Repeat password')),
			'email_confirmed'    => UserManagementModule::t('back', TranslationHelper::translate('E-mail confirmed')),
