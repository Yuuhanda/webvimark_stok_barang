...
$this->title = UserManagementModule::t('back', TranslationHelper::translate('Users'));
			...
			<?= GridView::widget([
				...
				'columns' => [
					...
					[
						'value'=>function(User $model){
								return GhostHtml::a(
									UserManagementModule::t('back', TranslationHelper::translate('Roles and permissions')),
					...
					[
						'value'=>function(User $model){
								return GhostHtml::a(
									UserManagementModule::t('back', TranslationHelper::translate('Change password')),
					...
					[
						...
						'attribute'=>'status',
						'optionsArray'=>[
							[User::STATUS_ACTIVE, UserManagementModule::t('back', TranslationHelper::translate('Active')), 'success'],
							[User::STATUS_INACTIVE, UserManagementModule::t('back', TranslationHelper::translate('Inactive')), 'warning'],
							[User::STATUS_BANNED, UserManagementModule::t('back', TranslationHelper::translate('Banned')), 'danger'],
						],
					],
